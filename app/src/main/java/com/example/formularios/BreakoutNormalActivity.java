...
public class BreakoutNormalActivity extends View {
    ...
    private int velocidPelotaX = 7, velocidPelotaY = -7; // Velocidad pelota
    ...
    private int maxVelocidPelotaX = 18;  // Velocidad máxima de la pelota (horizontal)
    private int maxVelocidPelotaY = 18;  // Velocidad máxima de la pelota (vertical)
    ...
    public BreakoutNormalActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        username = prefs.getString("current_username", "Guest"); // "Player" como valor predeterminado
...
// Borde dorado ajustado al nuevo tamaño
    ...
    private void moverPelota() {
        ...
        if (pelotaY >= topAreaJuego + altoAreaJuego) {
            ...
            if (dbHelper != null && puntuacion > 0) { // Solo guardar si hay puntuación
                dbHelper.saveScoreBreakout(actualUsername, puntuacion, segundosTranscurridos);
            }
        }
    ...
    private void mensajeGanar() {
        ...
        // Asegurarse de que el username está asignado correctamente
        SharedPreferences prefs = getContext().getSharedPreferences("GamePrefs", Context.MODE_PRIVATE);
        String actualUsername = prefs.getString("username", "Player");
    ...
    public void nuevoJuego() {
        ...
        velocidPelotaX = 7;        // Se reinicia velocidad de la pelota
        velocidPelotaY = -7;
