...
public class Levels2048Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2048levels);
        ...
        buttonNormal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Levels2048Activity.this, Normal2048Activity.class);
                intent.putExtra("current_username", username);
                startActivity(intent);
                // Aquí iría la lógica para iniciar el juego 1
                Toast.makeText(Levels2048Activity.this, "NORMAL LEVEL",
        ...
        buttonHard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Levels2048Activity.this, Hard2048Activity.class);
                intent.putExtra("current_username", username);
                startActivity(intent);
                // Aquí iría la lógica para iniciar el juego 1
                Toast.makeText(Levels2048Activity.this, "HARD LEVEL",
                        Toast.LENGTH_SHORT).show();
            }
        });
