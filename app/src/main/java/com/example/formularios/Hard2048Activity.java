...
public class Hard2048Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard2048);
        ...
        best = dbHelper.getBestScore2048Hard(currentUsername);
    ...
    protected void onPause() {
        ...
        if (score > dbHelper.getBestScore2048Hard(currentUsername)) {
            dbHelper.saveScore2048Hard(currentUsername, score);
        }
    }
    ...
    private void positionRandom() {
        ...
        // 89% de 1, 10% de 2 y 1% de 512
        board[x][y] = random.nextInt(100) < 89 ? 1 : (random.nextInt(100) < 90 ? 2 : 512);
    }
    ...
    private void victoriaDialog() {
        ...
        new AlertDialog.Builder(Hard2048Activity.this)
        ...
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
                ...
                if (value == 0) { // Si no hay ficha en la celda
                    ...
                    switch (value) {
                        case 1:
                            cell.setBackgroundResource(R.drawable.ficha_color1);
    ...
    private void showInfoDialog1() {
        ...
        new AlertDialog.Builder(Hard2048Activity.this)
                ...
                .setMessage("The dynamics of the game are the same as the normal level, but...") // Mensaje
    ...
    private void showInfoDialog2() {
        ...
        new AlertDialog.Builder(Hard2048Activity.this)
                .setTitle("Tutorial") // Título
                .setMessage("Now there are squares of 1!!!!") // Mensaje
                .setPositiveButton("Next", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void showInfoDialog3() {
        ...
        new AlertDialog.Builder(Hard2048Activity.this)
                ...
                .setMessage("Will you be able to beat the level?") // Mensaje
    ...
    private void openLeaderboard() {
        Intent intent = new Intent(Hard2048Activity.this, StatsActivity.class);
